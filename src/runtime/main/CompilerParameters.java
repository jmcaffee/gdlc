...
public class CompilerParameters extends CommandLineParameters {
	...
	public	boolean				applyDpmDataType	= false;
	public	boolean				applyPpmDataType	= false;
	
	public	boolean				outputDpmDataTypeInLookups	= true;
	public	boolean				outputPpmDataTypeInLookups	= true;
	...
	public void usage(){
		...
		System.out.println();
		System.out.println("	-Vfd          force output of DPM DataType.");
		System.out.println("	-Vfp          force output of PPM DataType.");
		System.out.println();
		System.out.println("	-Vod          do NOT output DPM DataType in lookups.");
		System.out.println("	-Vop          do NOT output PPM DataType in lookups.");
		System.out.println();
	...
	protected void processSwitches(){
		for( String sw : this.switches){
			...
			if(sw.equals("Vod")){
				this.outputDpmDataTypeInLookups	= false;
				if(this.verbose){
					Log.info("DPM DataType will NOT be output in lookups.");
				}
				continue;
			}

			if(sw.equals("Vop")){
				this.outputPpmDataTypeInLookups	= false;
				if(this.verbose){
					Log.info("PPM DataType will NOT be output in lookups.");
				}
				continue;
			}

			if(sw.equals("Vfd")){
				this.applyDpmDataType = true;
				if(this.verbose){
					Log.info("Forcing output of DPM DataType");
				}
				continue;
			}

			if(sw.equals("Vfp")){
				this.applyPpmDataType = true;
				if(this.verbose){
					Log.info("Forcing output of PPM DataType");
				}
				continue;
			}
