...
public class CompilerParameters extends CommandLineParameters {
    ...
    public  boolean             validXml        = false;    // Output valid XML (space before closing bracket of short tags).
    ...
    public void usage(){
        ...
        System.out.println();
        System.out.println("   __switches__");
        ...
        System.out.println();
        System.out.println("   __parameters__");
    ...
    public void version(){
        ...
        System.out.println();
        System.out.println("Copyright (C) 2016 Jeff McAffee");
        System.out.println();
    ...
    protected void processSwitches(){
        for( String sw : this.switches){
            ...
            if(sw.equalsIgnoreCase("validxml")){
                this.validXml = true;
                if(this.verbose){
                    Log.info("Valid XML output: on");
                }
                continue;
            }
